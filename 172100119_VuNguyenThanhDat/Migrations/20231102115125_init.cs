    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CacTheLoai", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CacTheLoai_SanPham_SanPhamId",
                        column: x => x.SanPhamId,
                        principalTable: "SanPham",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CacTheLoai_TheLoai_TheLoaiId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SanPhamId = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    ApplicattionUserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GioHang", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GioHang_AspNetUsers_ApplicattionUserId",
                        column: x => x.ApplicattionUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CacTheLoai_SanPhamId",
                table: "CacTheLoai",
                column: "SanPhamId");

            migrationBuilder.CreateIndex(
                name: "IX_CacTheLoai_TheLoaiId",
                table: "CacTheLoai",
                column: "TheLoaiId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GioHang_ApplicattionUserId",
                table: "GioHang",
                column: "ApplicattionUserId");
